    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        void ControlMovement()
		{
			...
			if (Input.GetButtonDown("Fire1"))
			{
				...
				if (currentBaseState.nameHash == idleState || currentBaseState.nameHash == locoState || currentBaseState.nameHash == thrustState)
				{
			...
			{
				if (currentBaseState.nameHash == idleState || currentBaseState.nameHash == locoState || currentBaseState.nameHash == sweepState)
				{
					if (!anim.IsInTransition(0))
					{
			...
			if (Input.GetButtonDown("Evade"))
			{
				...
				if (currentBaseState.nameHash == idleState || currentBaseState.nameHash == locoState)
				{
					if (!anim.IsInTransition(0))
					{
						x = Input.GetAxisRaw("Evade");
						anim.SetBool("Evade", true);
						anim.SetBool("EvadeLeft", x < 0);
					}
				}
			}
		}
